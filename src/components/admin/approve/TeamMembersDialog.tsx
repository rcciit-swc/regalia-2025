        ...
        >
          {members && members.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {members.map((member, index) => (
                <motion.div
                  ...
                  initial="hidden"
                  animate="visible"
                  className="bg-[#210000]/80 border border-yellow-500/20 p-6 rounded-xl hover:border-yellow-500/40 transition-all duration-300 transform hover:-translate-y-1"
                >
                  <div className="grid gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="font-antolia tracking-wider text-xl text-white">{member.name}</p>
                      </div>
                    </div>
                    ...
                    <div className="pl-12 grid gap-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-white break-all">{member.email}</p>
                        </div>
                      </div>
                      ...
                      {member.college && (
                        <div className="flex items-center gap-3">
                          <Building size={18} className="text-yellow-500/70" />
                          <div>
                            <p className="text-sm text-yellow-200/70">College</p>
                            <p className="font-medium text-white">{member.college}</p>
                          </div>
                        </div>
                      )}
                    </div>
            ...
            <div className="py-12 text-center">
              ...
              <p className="text-yellow-200/70 text-lg">No team members found</p>
            </div>
          )}
        </motion.div>
