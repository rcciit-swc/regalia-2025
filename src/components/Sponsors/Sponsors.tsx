...
export default function Sponsors() {
  ...
  return (
    ...
    >
      ...
      {/* Left content */}
      <div
        className={`flex flex-col z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
      >
      ...
      {/* Guitar image */}
      <div
        className={`flex items-center justify-center relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
      >
