...
const Footer = () => {
  ...
  return (
    <footer id="footer" className="relative bg-gradient-to-b from-[#310000] to-[#210000] text-[#F5E1DA] pt-12 pb-4 overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 items-start mt-5 relative z-10">
        ...
        >
          ...
          <motion.div className="flex items-center space-x-6" variants={staggerChildren}>
            <motion.a
        ...
        >
          <motion.ul className="flex flex-wrap gap-4 justify-center items-center lg:space-y-2 lg:inline-block  font-antolia font-normal text-xl md:text-2xl lg:text-4xl">
            ...
            <motion.li variants={menuItemVariants}>
              <a href="/events" className="hover:text-yellow-200 transition-colors duration-300 relative group">
                Events
                <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-yellow-300 transition-all duration-300 group-hover:w-full"></span>
              </a>
            </motion.li>
            <motion.li variants={menuItemVariants}>
              <a href="/team" className="hover:text-yellow-200 transition-colors duration-300 relative group">
                Team
                <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-yellow-300 transition-all duration-300 group-hover:w-full"></span>
              </a>
            </motion.li>
            <motion.li variants={menuItemVariants}>
              <a href="/gallery" className="hover:text-yellow-200 transition-colors duration-300 relative group">
                Gallery
                <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-yellow-300 transition-all duration-300 group-hover:w-full"></span>
              </a>
            </motion.li>
            <motion.li variants={menuItemVariants}>
              <a href="/contact" className="hover:text-yellow-200 transition-colors duration-300 relative group">
                Contact
                <span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-yellow-300 transition-all duration-300 group-hover:w-full"></span>
              </a>
            </motion.li>
        ...
        >
          ...
          >
            <h3 className="text-xl font-cogley text-yellow-200 mb-2">Event Dates</h3>
      ...
      >
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-[#F5E1DA] opacity-80">© 2025 Music Festival. All rights reserved.</p>
