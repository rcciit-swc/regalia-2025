...
import { Calendar, Users, Award, ArrowRight, CheckCircle, Star, Sparkles } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="p-6 border-t border-[#E8D0C9]/10 bg-gradient-to-b from-[#4A0000] to-[#3A0000] relative">
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="flex items-center mt-2">
            ...
            <span className="text-lg font-bold text-yellow-300">₹{registration_fees}</span>
          </div>
        </div>
        ...
        >
          {registered ? (
            ...
            >
              Register Now
              <ArrowRight size={18} className="ml-2 opacity-0 group-hover:opacity-100 transition-opacity" />
      ...
      <motion.div
        ...
        animate={isHovered ? { scale: 1, opacity: 0.6 } : { scale: 0.5, opacity: 0 }}
        transition={{ duration: 0.4 }}
      />
