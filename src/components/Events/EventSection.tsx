...
const EventSection = () => {
  ...
  const getButtonPosition = () => {
    ...
    const verticalOffset = windowSize.width < 640 ? 52 : windowSize.height * 0.22
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div 
          ...
          style={{
            background: "radial-gradient(circle at 30% 50%, rgba(255,180,0,0.15), transparent 40%), radial-gradient(circle at 70% 20%, rgba(255,100,50,0.12), transparent 50%)",
          }}
          animate={{ 
            scale: [1, 1.05, 1],
          ...
          return (
            <motion.div
              ...
              transition={{
                ...
                rotate: { duration: icon.duration * 1.5, repeat: Infinity, ease: "easeInOut" },
                scale: { duration: icon.duration, repeat: Infinity, ease: "easeInOut" },
                delay: icon.delay
              }}
            >
      ...
      <div className="relative h-full w-full">
        ...
        <motion.div
          ...
          animate={isScattered ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.8 }}
        ...
        >
          ...
          >
            <motion.span 
              className="absolute inset-0 bg-yellow-300 opacity-20 transition-all duration-300 transform origin-left scale-x-0 group-hover:scale-x-100"
            />
            Register Now
            <motion.div 
