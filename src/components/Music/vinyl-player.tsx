  ...
  useEffect(() => {
    ...
    try {
      ...
      setPlayerStatus((prev) => ({
        ...
        initAttempts:
          prev.initAttempts < 3 ? prev.initAttempts + 1 : prev.initAttempts,
      }));
    }
          ...
          >
            <div className="w-full h-full">
              <svg className="w-full h-full" viewBox="0 0 800 800">
                ...
                <text
                  transform="matrix(1 0 0 1 381.8867 509.8047)"
                  style={{
                    opacity: 0.2,
                    fontFamily: 'Arial',
                    fontSize: '50.4557px',
                ...
                <text
                  transform="matrix(-1 0 0 1 418.2188 509.8047)"
                  style={{
                    opacity: 0.2,
                    fontFamily: 'Arial',
                    fontSize: '50.4557px',
          ...
          >
            <svg className="w-full h-full" viewBox="0 0 800 800">
              ...
              <path
                style={{ fill: '#fff' }}
                className="grabbable"
                d="M353,738.9l18.3-22.9l13.2,6.4l-6.2,28.7l-22.8,47.1c0,0-1.2,3.3-15.4-3.6c-11.2-5.4-10-8.7-10-8.7L353,738.9z"
              ></path>
            </svg>
          </motion.div>
        </div>
