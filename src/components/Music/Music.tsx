      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {[1, 2, 3, 4, 5, 6, 7].map((i) => (
          <motion.div
            ...
            animate={isVisible ? { 
              x: [`${Math.random() * (i % 2 === 0 ? 100 : 0)}%`, `${Math.random() * 100}%`],
        ...
        >
          ...
          >
            <motion.p variants={fadeInUp} className="leading-relaxed">
              ...
              is scheduled to be held in the month of May.
            </motion.p>
            
            <motion.p variants={fadeInUp} className="leading-relaxed">
              Regalia 2024 fest promises to be an exciting and colorful extravaganza of 
              <span className="text-amber-200 font-semibold"> music, dance, drama, fashion show </span> 
              and more. There will be a wide range of events and activities, including a fashion show, 
              a group dance competition, a battle of bands, a singing competition and more.
            </motion.p>
            ...
            <motion.p variants={fadeInUp} className="leading-relaxed font-semibold text-amber-100">
